...
var incompleteTaskHolder=document.getElementById("incomplete-tasks-id");//ul of #incomplete-tasks
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task-item__field field";
...
var taskCompleted=function(){
  ...
  var taskTitle=listItem.querySelector("label.task-item__title");
  taskTitle.classList.add("task-item__title_completed");
...
var taskIncomplete=function(){
  ...
  var taskTitle=listItem.querySelector("label.task-item__title");
  taskTitle.classList.remove("task-item__title_completed");
